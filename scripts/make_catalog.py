...
cat_base = '/home/aroman/data/vr_source/desi_ls/'
version = 'v02'
sdss_base = '/home/aroman/data/vr_source/v01/sdss/'

# v0_base = '/home/aroman/data/vr_source/v00/'
# v0_set = get_files(v0_base)
north_cmass = cat_base + version + '_desils_north_cmass.h5'
south_cmass = cat_base + version + '_desils_south_cmass.h5'
north_lowz = cat_base + version + '_desils_north_lowz.h5'
south_lowz = cat_base + version + '_desils_south_lowz.h5'

parent_set = [north_cmass, south_cmass, north_lowz, south_lowz]
...
catalog_sets = [[a,] for a in parent_set]

set_names = ['north_cmass', 'south_cmass', 'north_lowz', 'south_lowz']
...
def do_gal_summaries():
    ...
    gal_out_base = '/home/aroman/data/vr_summaries/desils/' + version + '_'
